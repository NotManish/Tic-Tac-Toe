  ...
  return (
    <div className='flex justify-center mt-16'>
      ...
      {tiles.map((currentTile, index) => {
        // Add custom border logic for each tile
        let className = '';
        if (index < 6) className += ' border-b-2 border-blue-500'; // Add bottom border for first two rows
        if (index % 3 !== 2) className += ' border-r-2 border-blue-500'; // Add right border for all except the last column
